...
def defaultchain():
    ...
    chain.Elements[0] = Classes.R('R', 2)
    chain.Elements.append(1)
    chain.Elements[1] = Classes.R('R', 1)
    chain.Elements.append(2)
    chain.Elements[2] = Classes.V('V', 58)
    chain.Elements.append(3)
    chain.Elements[3] = Classes.R('R', 2)
    chain.Elements.append(4)
    chain.Elements[4] = Classes.R('R', 20)
